...
# run_scen('0627_30min', model_relax_w, mode='model_relax_w', instance_num=30, run_time=1800,
#           scenario_list=scenario_list, start_instance_num=1)
run_scen('0627_5min_1', model_relax_w, mode='model_relax_w', instance_num=5, run_time=300,
          scenario_list=scenario_list, start_instance_num=1)
run_scen('0627_5min_6', model_relax_w, mode='model_relax_w', instance_num=5, run_time=300,
          scenario_list=scenario_list, start_instance_num=6)
run_scen('0627_5min_11', model_relax_w, mode='model_relax_w', instance_num=5, run_time=300,
          scenario_list=scenario_list, start_instance_num=11)
run_scen('0627_5min_16', model_relax_w, mode='model_relax_w', instance_num=5, run_time=300,
